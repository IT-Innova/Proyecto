...
public class CaminarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtNombreActividad.setText("Caminar");
        ...
        btnGuardaCorrer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!txtNombreActividad.getText().toString().equals("") && !txtTiempo.getText().toString().equals("")) {
                    ...
                    DbActividadFisica dbActividadFisica = new DbActividadFisica(CaminarActivity.this);
                    ...
                    if (id > 0) {
                        Toast.makeText(CaminarActivity.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                        limpiar();
                    } else {
                        Toast.makeText(CaminarActivity.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(CaminarActivity.this, "DEBE LLENAR LOS CAMPOS OBLIGATORIOS", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
